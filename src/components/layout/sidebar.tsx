...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 h-screen sticky top-0 bg-white dark:bg-[oklch(0.195_0.004_260)] border-r border-gray-100 dark:border-white/8 flex flex-col shadow-sm" data-sidebar>
      {/* Logo */}
