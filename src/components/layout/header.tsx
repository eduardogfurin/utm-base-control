...
const titles: Record<string, string> = {
  ...
  "/links": "Links",
  "/tracking": "Relatórios",
  "/integrations": "Meu Perfil / Integrações",
...
const subtitles: Record<string, string> = {
  ...
  "/integrations": "Conecte seus encurtadores de link",
...
export function Header() {
  ...
  return (
    <header className="h-16 border-b border-gray-100 dark:border-white/7 flex items-center px-6 bg-white/80 dark:bg-[oklch(0.11_0_0/0.85)] backdrop-blur sticky top-0 z-10">
      <div>
